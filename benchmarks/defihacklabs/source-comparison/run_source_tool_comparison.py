...
BENCHMARK_ID = "defihacklabs-source-comparison"
TITLE = "DeFiHackLabs source-tool comparison corpus"
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        f"# DeFiHackLabs Source-Tool Comparison Report - {payload['executed_at']}",
        "",
...
def run_benchmark(*, now: dt.datetime | None = None) -> dict[str, Any]:
    ...
    manifest_entry = {
        "id": run_id,
        "target": "anchor_sarif",
        "title": "DeFiHackLabs source-tool comparison benchmark run",
        "status": "complete",
        "level": "Phase 3",
...
def main() -> int:
    ...
    print(f"Created DeFiHackLabs benchmark run: {payload['run_id']}")
