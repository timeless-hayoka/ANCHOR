# DVD Phase 1 Scaffold Run - 2026-06-26T23-42-35Z

## Metadata
- Benchmark ID: `dvd-phase1-local`
- Executed at: `2026-06-26T23:42:35.437391+00:00`
...
- `shards` -> observed `PASSED` / expected `pass` / comparison `aligned`
  ...
  - log: `benchmarks/damn-vulnerable-defi/runs/2026-06-26T23-42-35Z/shards.log`
- `wallet-mining` -> observed `TIMED_OUT` / expected `pass_or_timeout_needs_investigation` / comparison `investigate_but_not_regression`
  ...
  - log: `benchmarks/damn-vulnerable-defi/runs/2026-06-26T23-42-35Z/wallet-mining.log`
- `withdrawal` -> observed `FAILED` / expected `environment_dependent` / comparison `environment_sensitive`
  ...
  - log: `benchmarks/damn-vulnerable-defi/runs/2026-06-26T23-42-35Z/withdrawal.log`
